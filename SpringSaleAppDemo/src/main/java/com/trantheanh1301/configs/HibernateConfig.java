...
@PropertySource("classpath:database.properties") // mạp file cấu hình từ resources
public class HibernateConfig {

    @Autowired  // giúp Spring quản lý và cung cấp các dependency cần thiết mà không cần khởi tạo bằng new.
    private Environment env;  //lấy các giá trị cấu hình từ các file .properties
...
//Giao tao -> nhớ qua bên WebAppContextCongig bật giao tác thêm @EnableTransactionManagement
